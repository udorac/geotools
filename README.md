...
```
composer require udorac/geotools
```
...
Bugs and feature request are tracked on [GitHub](https://github.com/udorac/geotools/issues)
...
[LICENSE](https://github.com/udorac/geotools/blob/master/LICENSE) file for details.